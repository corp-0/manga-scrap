import unittest
from manga_scrap.modelos import Manga, Capitulo, Imagen, Genero
...
class TestManga(unittest.TestCase):
    def setUp(self) -> None:
        ...
        genero_1 = Genero("Hentai")
        genero_2 = Genero("Hentai duro!")
        self.manga = Manga("nombre", "imagen", "enlace", [capitulo], [genero_1, genero_2])
    ...
    def test_contador_generos(self):
        self.assertEqual(2, self.manga.n_generos)
